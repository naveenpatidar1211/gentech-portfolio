...
function Skills() {
  ...
  return (
    <section 
      id="skills" 
      ref={ref}
      className={`skills reveal ${visible ? "active" : ""}`}
    >
      <div className="container">
        ...
        <div className="skills-grid">
          <div className={`skill-card reveal delay-1 ${visible ? "active" : ""}`}>
          ...
          <div className={`skill-card reveal delay-2 ${visible ? "active" : ""}`}>
            <div className="skill-icon">
          ...
          <div className={`skill-card reveal delay-3 ${visible ? "active" : ""}`}>
            <div className="skill-icon">
          ...
          <div className={`skill-card reveal delay-4 ${visible ? "active" : ""}`}>
            <div className="skill-icon">
